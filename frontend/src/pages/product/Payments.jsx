...
const Payments = () => {
  const {selected,setSelected,payment,setPayment,input1,input2,order,setOrder,after,setAfter,setInput1,setInput2,setShow} = useContext(VariableContext)
  ...
  return (
    ...
    <li>
        ...
        onClick={(selected !== null && payment !== null && input1 !== null && input2 !== null) ? handleSubmit : () =>setShow(true)}>BUY NOW</button> :
