  ...
  return (
    <div className="py-[1.5em] px-[2em]  bg-[#293133] flex flex-col  rounded-[1em] w-full">
      <div className='flex justify-between mb-3'>
        ...
        <div className='text-[1.4rem] font-[600] text-[#00BBFF]'>$180.25</div>
      </div>
    ...
    <li>
        ...
        <label for="hosting-small" class="inline-flex items-center  w-full p-5 text-gray-500 bg-white border-[3px]  rounded-[1em] cursor-pointer dark:hover:text-gray-300 dark:border-gray-800 dark:peer-checked:text-blue-500 peer-checked:border-[#10779B] peer-checked:text-blue-600 hover:text-gray-600 hover:bg-gray-100 dark:hover:border-gray-700 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 gap-3">  
    ...
    <li>
        ...
        <button className='bg-[#00C5FF] hover:bg-blue-600 rounded-full p-2.5 text-white font-[600] text-[1.1rem] w-full'>BUY NOW</button>
      </div>
