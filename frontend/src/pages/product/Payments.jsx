...
const Payments = () => {
  const {selected,setSelected,payment,setPayment,input1,input2,order,setOrder,after,setAfter,setInput1,setInput2,setShow,isLoggedIn,user,token,verified,mlbb} = useContext(VariableContext)
  ...
  return (
    ...
    <li>
        ...
        (
        (selected !== null && payment !== null && input1 !== null && input2 !== null && (productId === mlbb ? verified : !verified)) ? handleSubmit() : setShow(true)))}>BUY NOW</button> :
