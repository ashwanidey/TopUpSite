...
// console.log(product.productid);
  ...
  //  console.log(values)
   if(payment === "upi")
    ...
    await postOrderWallet(values,token);
  ...
  return (
    ...
    <li>
        ...
        (
        (selected !== null && payment !== null && input1 !== null && input2 !== null && (id === mlbb || id === mlbbph ? verified : !verified)) ? handleSubmit() : setShow(true)))}>BUY NOW</button> :
