...
const GridCards = ({data}) => {
  ...
  return (
    <div className="w-full">
      <a
        href={`/product/${data._id}/${data.productid}`}
        className="relative rounded-[1em] flex items-center text-center flex-col mt-[30px] px-[8px] pt-[33px] pb-[8px] bg-[#23292A] h-[89%]"
